      ...
      <div className="hero-section">
        ...
        <div className="welcome-content">
          <h1 className="hero-title">
            StoryTeller — Your Gateway to Epic Interactive Adventures
          </h1>
          <p className="hero-tagline">
            Stories shaped by your choices, crafted with cutting-edge
            technology.
          </p>
          <p className="hero-subtitle">
            Create <b>personalized interactive adventures</b> that adapt to your
            choices. Craft a <b>unique character</b> and embark on{" "}
            <b>epic journeys</b>
      ...
      <section className="how-it-works-section">
        ...
        <div className="steps-grid">
          ...
          <div className="step-card">
            ...
            <p>
              Get a unique opening chapter crafted specifically for your
              character and chosen setting, with rich details and compelling
              narrative.
            </p>
          </div>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Experience unique, richly detailed stories that adapt to your
              choices, powered by cutting-edge AI technology.
            </p>
          </div>
